  ...
  return (
    <div className="min-h-[calc(100vh-150px)] max-w-[760px] flex flex-col gap-8 mx-auto w-screen">
      ...
      <div>
        ...
        <p className="font-light text-zinc-400  leading-relaxed mt-6">Plataforma digital baseado no stackoverflow.Onde podemos criar tópicos , responder esses tópicos , criar uma resposta para a resposta do tópico e contando com um sistema de notificação .  </p>
